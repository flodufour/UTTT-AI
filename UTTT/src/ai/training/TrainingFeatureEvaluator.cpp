...
int TrainingFeatureEvaluator::evaluate(const GameState& state) const
{
    Features f = extract(state);
    return dot(f);
}

TrainingFeatureEvaluator::Features
TrainingFeatureEvaluator::extract(const GameState& state) const
{
    Features f;
...
void TrainingFeatureEvaluator::extractTerminal(
...
void TrainingFeatureEvaluator::extractMeta(
    const UltimateBoard& b,
    Features& f,
    CellState me,
    CellState opp) const
...
void TrainingFeatureEvaluator::extractSubBoards(
    const UltimateBoard& b,
    Features& f,
    CellState me,
    CellState opp) const
...
void TrainingFeatureEvaluator::extractForcedMoves(
    const UltimateBoard& b,
    Features& f,
    CellState me,
    CellState opp) const
...
int TrainingFeatureEvaluator::evaluateMetaImportance(
    const UltimateBoard& b,
    int boardIndex,
    CellState me,
    CellState opp,
...
int TrainingFeatureEvaluator::dot(const Features& f) const
{
    int score = 0;
